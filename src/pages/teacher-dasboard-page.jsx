...
const TeacherDashboard = () => {
    ...
    async function publish(id) { await apiFetch(token, `/api/assignments/${id}/publish`, { method: 'POST' }); load(); }
    ...
    return (
        <div style={{ padding: 20 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 20 }}>
                <Space>
                    <Button type="primary" onClick={() => setIsModalVisible(true)}>Create Assignment</Button>
                    <Select
                        value={statusFilter}
                ...
                renderItem={a => (
                    <List.Item
                        actions={[
                            ...
                            a.status === 'DRAFT' && <Button onClick={() => remove(a.id)} danger>Delete</Button>,
